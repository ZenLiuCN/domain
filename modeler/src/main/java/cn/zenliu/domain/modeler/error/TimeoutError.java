...
public class TimeoutError extends DomainError {
    ...
    public TimeoutError(@Nullable String userMessage, @Nullable String message) {
        super(code, userMessage, message);
    }

    public TimeoutError(@Nullable String userMessage, @Nullable String message, Throwable cause) {
    ...
    public TimeoutError(@Nullable String userMessage, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
